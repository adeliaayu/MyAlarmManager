package com.dicoding.kotlin.myalarmmanager
...
class AlarmReceiver : BroadcastReceiver() {
    ...
    // Metode ini untuk menjalankan alarm one time
    fun setOneTimeAlarm(
        context: Context,
        type: String,
        date: String,
    ...
    // Metode ini untuk menjalankan alarm repeating
    fun setRepeatingAlarm(context: Context, type: String, time: String, message: String) {
        ...
        Toast.makeText(context, "Repeated alarm set up", Toast.LENGTH_SHORT).show()
    }
    ...
    // Metode ini untuk mengecek apakah alarm tersebut sudah terdaftar di alarm manager
